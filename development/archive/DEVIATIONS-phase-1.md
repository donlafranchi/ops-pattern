---
purpose: Archived DEVIATIONS entries from Phase 1 of the rebuild (T041–T066).
layer: how
status: archived
rotated_on: 2026-05-30
rotated_from: development/DEVIATIONS.md
phase: Phase 1
covers: T041 through T066 (substrate floor + b1.x sprint close)
---

# DEVIATIONS — Phase 1 (archived)

> **Archived 2026-05-30** at the Phase 1→2 rotation boundary. Phase 1 ran from 2026-05-12 (T051) through 2026-05-25 (T065/T066 b1.x close). All entries below were live in `development/DEVIATIONS.md` until rotation.
>
> The live file is at [`../DEVIATIONS.md`](../DEVIATIONS.md). New entries go there.
