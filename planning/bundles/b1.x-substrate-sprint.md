...
**Status:** Drafted 2026-05-25 (Cowork planning handoff). Companion to [`b1-primitives-work-map.md`](b1-primitives-work-map.md) § b1.x, [`../rebuild-plan.md`](../rebuild-plan.md) Phase 1+ substrate, and [`../STAGE-LEDGER.md`](../STAGE-LEDGER.md) Substrate row *"Phase 1+ — Member↔Geography substrate (ADR-21)."*
