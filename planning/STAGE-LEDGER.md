...
| F036 | Member creates business Group via Sell walkthrough | `building` 2026-05-31 (T070 done; M2 trail closed) | groups.md kind='business', member.md, location.md, action-layer.md, business-jurisdiction.md, ui/design-language.md (Multi-step composer + AddEntityDrawer) | 2026-05-28 → approved 2026-05-31 (Gate A cleared via weigh: 4 absolutes ratified) | written 2026-05-31 (`web/evals/features/F036-member-creates-business-group-via-sell-walkthrough.spec.ts`) | EXTEND 2026-05-31 (cleared by DLS extend 2026-05-31) | T070 (substrate ✅ 2026-05-31 — M2 trail closed: 2 criticals applied + 3 suggestions folded + 4 deferred per `planning/reviews/F036-review.md`) + T071–T073 (F036, open) | T071→T073 pending | — | Anchor: use-cases.md P1. Replaces archived F026 (Group-creation half). T070 ✅ on branch t070 (commit pending PM): migration 023 + 3 group handlers + `src/actions/group/constants.ts`; 40/40 vitest GREEN; M2 REQUEST→PROCEED. T071/T072/T073 still queued. Shop vs Group copy decision still pending (T073 defaults to "Shop"). Eval spec covers 5 acceptance criteria + 3 edge cases; F036 fixture (`web/evals/fixtures/F036-maya.ts`) belongs to T073. |
