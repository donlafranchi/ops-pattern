...
|---|---|---|---|---|---|---|---|---|---|---|
| F030 | Newcomer signs up and lands in feed | `scoped` 2026-06-02 (moved → `planning/now/`; ticketing blocked) | member.md, discovery.md, places.md; ADR-21 | 2026-05-28 → moved → `planning/now/` 2026-06-02 (PM-directed) | — (no review-F030 yet — rebuild rule 1 gate) | — | — | — | Anchor: use-cases.md C1. Replaces archived F028. First scenario in the Phase 2 sequence. **Tickets blocked 2026-06-02**: (1) deps F036 (eval 5/9; 4 reds) + F038 (`t77` unmerged) not met — F034 + F040 done; (2) auth-method decision unratified (scenario Assumptions gate); (3) review-F030 missing. |
