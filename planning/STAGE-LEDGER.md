...
| F036 | Member creates business Group via Sell walkthrough | `building` 2026-05-31 (T070 + T071 + T072 done; T073 built 2026-06-01 pending commit) | groups.md kind='business', member.md, location.md, action-layer.md, business-jurisdiction.md, ui/design-language.md (Multi-step composer + AddEntityDrawer) | 2026-05-28 → approved 2026-05-31 (Gate A cleared via weigh: 4 absolutes ratified) | written 2026-05-31 (`web/evals/features/F036-member-creates-business-group-via-sell-walkthrough.spec.ts`) | EXTEND 2026-05-31 (cleared by DLS extend 2026-05-31) | T070 (substrate ✅ `d8204c7`→`39b11df`) + T071 (`<MultiStepComposer>` ✅ `d31f3ff`→`3c64571`) + T071a (dev-route gate ✅ `c7d9f3e`→`8da39a4`) + T072 (`<AddEntityDrawer>` ✅ `3276666`→`08d7667`) + T073 (built 2026-06-01 on branch t073; M2 self-review PROCEED after 3 fix-now; 73/73 src/ vitest GREEN; pending PM commit) | T070→T072 done; T073 awaiting PM commit | — | Anchor: use-cases.md P1. T070+T071+T071a+T072 all merged to main. T073 built and tested; 2 SPEC-PATCHES queued (locality substrate gap → F037; missing `location.create` handler). Shop copy ratified for T073 per F036 review § Decisions captured #2. |
