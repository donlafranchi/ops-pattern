...
| F036 | Member creates business Group via Sell walkthrough | `building` 2026-05-31 (T070 + T071 + T072 done) | groups.md kind='business', member.md, location.md, action-layer.md, business-jurisdiction.md, ui/design-language.md (Multi-step composer + AddEntityDrawer) | 2026-05-28 → approved 2026-05-31 (Gate A cleared via weigh: 4 absolutes ratified) | written 2026-05-31 (`web/evals/features/F036-member-creates-business-group-via-sell-walkthrough.spec.ts`) | EXTEND 2026-05-31 (cleared by DLS extend 2026-05-31) | T070 (substrate ✅ `d8204c7`→`39b11df`) + T071 (`<MultiStepComposer>` ✅ `d31f3ff`→`3c64571`) + T071a (dev-route gate ✅ `c7d9f3e`→`8da39a4`) + T072 (`<AddEntityDrawer>` ✅ `3276666`→`08d7667`) + T073 (open) | T070→T072 done; T073 pending | — | Anchor: use-cases.md P1. T070+T071+T071a+T072 all merged to main. T073 still queued. Shop vs Group copy decision still pending (T073 defaults to "Shop"). |
