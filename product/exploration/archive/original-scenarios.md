# Movers, Makers & Shakers — Founding Scenarios

> These scenarios define the core user intents for the Movers, Makers & Shakers product.
...
**Narrative:**
Robert is a semi-retired accountant who reads a lot of business news. He's been using Movers, Makers & Shakers for a month and has noticed that a dental practice in his neighborhood recently changed its name subtly and started advertising aggressively — a classic post-acquisition pattern. He searches it on the app, finds it listed as "Independent." He taps "Flag this listing" and submits: "Name changed from Eastside Dental to Smile Brands affiliate in Q1 2024. SEC filing linked." An admin reviews it within 48 hours, verifies via the linked filing, and changes the pin to grey with a note: "Acquired by Smile Brands (PE-backed, 400+ locations) 2024." Robert gets a notification: "Your flag was verified. Thank you." He's contributed something real. He flags two more that week.
...
**Core message:** The free market only works when there's real competition. Private equity doesn't win through better products or lower prices — it wins by eliminating choice. Movers, Makers & Shakers helps people find businesses where their money stays in the community and competition is still alive.
