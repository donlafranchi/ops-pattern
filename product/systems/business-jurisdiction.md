...
**Surfaces.**
- **Composer.** The "Become a Maker" walkthrough (per `member.md` Maker mode) adds an optional "where is this business based?" step. Self-attested ZIP only; no document upload at b1.
...
This spec is the live home for the locality-verification-ladder decision (ratified 2026-05-11; formerly captured in `product/exploration/locally-owned-verification.md`). See [`../../planning/DECISIONS.md`](../../planning/DECISIONS.md) for the cross-cutting register.
