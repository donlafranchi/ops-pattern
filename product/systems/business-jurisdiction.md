...
6. **Accountable-participation interaction.** This system makes jurisdiction-based claims about kind='business' Groups. It does NOT enable any messaging or feed scoped to a jurisdiction; jurisdiction is a property of the Group, not an addressability surface. The no-Location-scoped-messaging commitment in `policy.md` is unaffected.
