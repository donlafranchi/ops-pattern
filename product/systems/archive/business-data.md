...
- **Platform Core:** Identity & Auth, Owner Profile (see `product/systems/platform-core.md`)
- Connects to: Ownership Classification
- Used by: Map System, Business Registration, Community Signals, Flagging
- Cross-vertical: Stays listings link to businesses via amenity showcase and local recommendations
