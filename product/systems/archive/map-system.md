...
- **Platform Core:** Shared map layer defined in `product/systems/platform-core.md` — this system implements the business-specific pin behavior on that shared layer
- Connects to: Business Data, Ownership Classification, Stays (T2 — rental pins)
- Used by: Map Search, Travel Browse, Community Seeding, Platform Map Discovery (multi-vertical at T2)
