...
- Cooperative-style coordination (co-owning, voting, distributing) — deferred until real-world need (see [`primitives.md`](../foundation/primitives.md)); not in current scope. kind='business' Groups with multiple owner-role memberships cover the cooperative-shape use case for now.
