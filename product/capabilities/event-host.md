...
- [`scenario-F018-brian-declares-run-club.md`](../../planning/done/2026-06-02-backlog-cleanup/scenario-F018-brian-declares-run-club.md) — the canonical example, fully specced.
