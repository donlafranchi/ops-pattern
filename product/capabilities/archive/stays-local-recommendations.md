...
**User Story:**
As a traveler, I want my host's personal recommendations for local spots, so I experience the neighborhood like a local instead of defaulting to chains.
...
**Out of Scope:**
- Sponsored recommendations (never — no pay-to-play)
- Automated recommendations based on location
