...
| Gather regularly | 4 | [`systems/item.md`](systems/item.md), [`systems/location.md`](systems/location.md) | [`capabilities/event-host.md`](capabilities/event-host.md) | [F018 — Brian declares the Run Club](../planning/done/2026-06-02-backlog-cleanup/scenario-F018-brian-declares-run-club.md) | T056 (items schema) | backlog (F018 deferred) |
...
| Follow what I love | 8 | [`systems/member.md`](systems/member.md) (`member_follows`), [`systems/location.md`](systems/location.md), [`systems/producer-tools.md`](systems/producer-tools.md) | Follow surface in [`capabilities/member-profile.md`](capabilities/member-profile.md); Location-follow per [`systems/location.md`](systems/location.md) | [F025 — folded into F032 (Member page + follow)](../planning/now/scenario-F032-viewer-finds-member-page-and-follows.md) | T048 (interests + follows), T049 (location affinities) | substrate-only (b1); surface b2 |
...
- **PM adds a row** when a new scenario lands in `planning/backlog/` or graduates to `planning/next/`. Source columns (Need / Loop / System / Capability) inherit from the scenario's anchor; right-hand columns (Feature / Scenario / Ticket / Status) update as the ticket sequence ships.
