...
| Gather regularly | 4 | [`systems/item.md`](systems/item.md), [`systems/location.md`](systems/location.md) | [`capabilities/event-host.md`](capabilities/event-host.md) | [F018 — Brian declares the Run Club](../planning/backlog/scenario-F018-brian-declares-run-club.md) | T056 (items schema) | backlog (F018 deferred) |
