...
2. **Gather regularly → Event-host UI** — F018 (Brian declares Run Club) is deferred; rewrite punch list lives in [the F018 review](../planning/history/F018-review.md). Picking this up means revising F018 against the post-2026-05-11 naming pass.
