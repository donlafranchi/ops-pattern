...
**Open:** when the Member is asked (signup vs. first creation); whether the feed unions all saved hoods or switches between them — which reopens which centre "nearby" is measured from; whether hoods are capped or one is primary. `decision-surfaces.md` § Open questions 4–6.
