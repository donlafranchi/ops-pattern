...
- **Active Phase 2 plan:** [`planning/bundles/b1-primitives-sequence.md`](planning/bundles/b1-primitives-sequence.md) — eight scenarios (F030–F037) + three substrate gates sequenced by build dependency, every F### anchored to one MVP-tagged row of `use-cases.md`. The strategy doc that preceded it was retired 2026-05-30 (`planning/archive/2026-05-30-phase-2-historical/`). Scenario files live in [`planning/scenarios-backlog/`](planning/scenarios-backlog/).
...
Active until the b1 user-surface set (F030–F037 per [`planning/bundles/b1-primitives-sequence.md`](planning/bundles/b1-primitives-sequence.md)) is shipped and the b1 bundle archives.
...
| [`planning/bundles/b1-primitives-sequence.md`](planning/bundles/b1-primitives-sequence.md) | The active b1 build sequence — F030–F037 + three substrate gates. Read by `scope` for every Phase 2 scenario. The strategy doc that preceded it was retired 2026-05-30. |
